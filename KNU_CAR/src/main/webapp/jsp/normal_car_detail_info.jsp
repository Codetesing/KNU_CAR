    ...
    <%@ page language="java"
     ...
     <%!
	     public void SEARCH(Connection conn, String car_id, String user_id) throws SQLException {
	 		...
	 		query = "SELECT * FROM NORMAL_CAR WHERE normal_car_id='" + car_id + "' AND " + "normal_user_id='" + user_id + "'";
	 		pstmt = conn.prepareStatement(query);
	 		rs2 = pstmt.executeQuery();
	 		
	 		query = "SELECT * FROM NORMAL_CAR_OPTION WHERE nnormal_car_id='" + car_id + "' AND " + "nnormal_user_id='" + user_id + "'";
	 		pstmt = conn.prepareStatement(query);
	 		rs3 = pstmt.executeQuery();

	 		query = "SELECT * FROM NORMAL_CAR_ACCIDENT_HISTORY WHERE accident_normal_car_id='" + car_id + "' AND " + "accident_normal_user_id='" + user_id + "'";
	 		pstmt = conn.prepareStatement(query);
